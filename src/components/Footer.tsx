...
export default async function Footer() {
    ...
    return (
        <Bounded as="footer" className="text-slate-600 fixed bottom-0">
            <div className="container mx-auto mt-20 flex flex-col items-center justify-around gap-6 sm:flex-row ">
